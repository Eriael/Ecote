...
class AssignmentOperatorVisitor : public CBaseVisitor
{
public:
	bool assignmentOperation = false;
	antlrcpp::Any visitAssignmentoperator(CParser::AssignmentoperatorContext *context);
