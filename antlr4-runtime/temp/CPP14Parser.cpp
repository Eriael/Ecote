...
CPP14Parser::PurespecifierContext* CPP14Parser::purespecifier() {
  ...
  try {
    ...
    if((dynamic_cast<PurespecifierContext *>(_localctx)->val != nullptr ? dynamic_cast<PurespecifierContext *>(_localctx)->val->getText() : "")!=std::string(0)) throw new InputMismatchException(this);
